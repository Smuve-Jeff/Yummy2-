...
import { PracticeSpaceComponent } from '../practice-space/practice-space.component'; // NEW: Import PracticeSpaceComponent
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, EqPanelComponent, MatrixBackgroundComponent, ChatbotComponent, ImageEditorComponent, VideoEditorComponent, AudioVisualizerComponent, PianoRollComponent, NetworkingComponent, PracticeSpaceComponent],
  host: {
...
export class AppComponent implements OnDestroy {
  ...
  // App mode
  mainViewMode = signal<'player' | 'dj' | 'piano-roll' | 'image-editor' | 'video-editor' | 'networking' | 'practice-space'>('player');
  ...
  toggleMainViewMode(): void {
    const modes = ['player', 'dj', 'piano-roll', 'image-editor', 'video-editor', 'networking', 'practice-space']; // NEW: Add 'practice-space'
