...
import { LegalModalComponent } from '../legal-modal/legal-modal.component'; // Import LegalModalComponent
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, EqPanelComponent, MatrixBackgroundComponent, ChatbotComponent, ImageEditorComponent, VideoEditorComponent, AudioVisualizerComponent, PianoRollComponent, DrumMachineComponent, WaveformComponent, LegalModalComponent, NetworkingComponent, UserProfileComponent],
  host: {
  ...
  handleChatbotCommand(command: { action: string; parameters: any; aiContext?: string }): void {
    ...
    switch (action) {
      ...
      case 'SYNC_DECK':
        ...
        break;
      case 'GENERATE_LEGAL_TEMPLATE':
        if (parameters.text) {
          this.legalDocumentText.set(parameters.text);
