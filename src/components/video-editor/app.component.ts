...
import { NotepadComponent } from '../notepad/notepad.component'; // NEW: Import NotepadComponent
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, EqPanelComponent, MatrixBackgroundComponent, ChatbotComponent, ImageEditorComponent, VideoEditorComponent, AudioVisualizerComponent, PianoRollComponent, NetworkingComponent, NotepadComponent],
  host: {
...
export class AppComponent implements OnDestroy {
  ...
  // App mode
  mainViewMode = signal<'player' | 'dj' | 'piano-roll' | 'image-editor' | 'video-editor' | 'networking' | 'notepad'>('player');
  ...
  toggleMainViewMode(): void {
    const modes = ['player', 'dj', 'piano-roll', 'image-editor', 'video-editor', 'networking', 'notepad']; // NEW: Add 'networking', 'notepad'
